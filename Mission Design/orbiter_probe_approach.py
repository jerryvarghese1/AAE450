...
planet.loadAtmosphereModel('uranus-gram-avg.dat', 0, 1, 2, 3, heightInKmFlag=True)
planet.h_low = 120e3
planet.h_trap = 100e3
...
p3 = mlab.plot3d(orbiter.x_orbit_arr,
				 orbiter.y_orbit_arr,
...
p4 = mlab.plot3d(orbiter.x_probe_orbit_arr,
				 ...
				 orbiter.z_probe_orbit_arr, color=(1, 0, 0), line_width=3, tube_radius=None)

p5 = mlab.plot3d(orbiter.x_orbiter_defl_arr,
