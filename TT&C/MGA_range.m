function [LM_uplink,  LM_downlink] = MGA_range(N, sc_power, sc_freq, sc_Data_rate, DSN_diam, DSN_power, DSN_freq, DSN_Data_rate)
    %Inital Variables
